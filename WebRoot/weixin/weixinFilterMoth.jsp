			    ...
			    <div id="ThreeRanking">
			        <div class="ranking fireRanking">
		                ...
		                <span class="indicates" style="width: 201px;margin: 10px auto;display: block;"">
		                	<input type="text" id="weixinTime" class="" ng-model="date" placeholder="例如：2017-01" style="width: 120px;">
	                    	<a class="btn filterder" ng-click="weixintimefilter('/report/queryPerformanceMoth.do')">提交</a>  
		                </span>
