...
var tableHeader = "<tr class='henglan'>"+
		...
		"<th class='studentName' style='width: 120px;position: fixed;left: 177px;background:#fff;'>姓名</th>"+
		"<th class='phone' style='width: 120px;position: fixed;left: 286px;background:#fff;'>手机</th>"+
		"<th class='idCard' style='width: 150px;position: fixed;left: 405px;background:#fff;'>身份证</th>"+
		"<th class='studentstate' style='width: 630px;padding-left: 560px;'>学员状态</th>"+
		"<th class='subjectname'>所报科目</th>"+
		"<th class='ispass'>是否全科通过</th>"+
		"<th class='customerName'>班主任</th>"+
		"<th class='address'>地区</th>"+ 
		"<th class='scoretime'>考试日期</th>"+
		"<th class='jijin1'>基金1</th>"+
		"<th class='jijin1Score'>考试成绩</th>"+
		"<th class='jijin2'>基金2</th>"+
		"<th class='jijin2Score'>考试成绩</th>"+
...
function fillTable(list,currentPage){ 
	$.each(list, function(index, array) {
	    ...
	    var subjectname = array.subjectname|| "";	    
	    var jijin1 = array.jijin1|| "";
	    var jijin2 = array.jijin2|| "";
	    var jijin1Score = array.jijin1Score|| "";
	    var jijin2Score = array.jijin2Score|| "";
	    var courseversion = array.courseversion|| "";
        ...
        "<td class='studentName' style='width: 120px;position: fixed;left: 177px;background-color:"+studentColor+"'>"+studentName+"</td>"+
        "<td class='phone' style='width: 120px;position: fixed;left: 286px;background-color:"+studentColor+"'>"+phone+"</td>"+
        "<td class='idCard' style='width: 150px;position: fixed;left: 405px;background-color:"+studentColor+"'>"+idCard+"</td>"+	
        "<td class='studentstate' style='width: 630px;padding-left: 560px;'>"+studentstate+"</td>"+
		...
		"<td class='jijin1'>"+jijin1+"</td>"+
		"<td class='jijin1Score'>"+jijin1Score+"</td>"+	        
		"<td class='jijin2'>"+jijin2+"</td>"+
		"<td class='jijin2Score'>"+jijin2Score+"</th>"+
...
function filter(){	
	...
	var ispass1 = $('#ispass1 option:selected').val();
	var ispass2 = $('#ispass2 option:selected').val();
	filterData = {
	    userid:userid,
		deptid:deptid,
    	roleid:roleid,
