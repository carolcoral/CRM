...
var tableHeader = "<tr class='henglan'>"+
		...
		"<th class='qhflfg'>期货法律法规</th>"+
		"<th class='qhflfgScore'>考试成绩</th>"+
		"<th class='qhjczs'>期货基础知识</th>"+
		"<th class='qhjczsScore'>考试成绩</th>"+
...
function fillTable(list,currentPage){ 
	$.each(list, function(index, array) {
	    ...
	    var subjectname = array.subjectname|| "";	    
	    var qhflfg = array.qhflfg|| "";
	    var qhjczs = array.qhjczs|| "";	    
	    var qhflfgScore = array.qhflfgScore|| "";
	    var qhjczsScore = array.qhjczsScore|| "";
        ...
        "<td class='qhflfg'>"+qhflfg+"</td>"+
        "<td class='qhflfgScore'>"+qhflfgScore+"</td>"+
        "<td class='qhjczs'>"+qhjczs+"</td>"+
        "<td class='qhjczsScore'>"+qhjczsScore+"</td>"+
