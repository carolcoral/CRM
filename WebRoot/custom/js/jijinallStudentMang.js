...
var tableHeader = "<tr class='henglan'>"+
		...
		"<th class='phone' style='width: 120px;position: fixed;background: #fff;left: 237px;'>手机</th>"+
		"<th style='width: 150px;position: fixed;background: #fff;left: 356px;'>身份证</th>"+
		"<th style='width: 580px;padding-left: 510px;'>学员状态</th>"+
		"<th>招生老师</th>"+
		"<th>收款金额</th>"+
		"<th style='width: 460px;'>科目</th>"+
		"<th>毕业院校</th>"+
		"<th>学历</th>"+
		"<th>地区</th>"+   
		"<th style='width: 80px;'>班主任</th>"+
		"<th style='width: 140px;'>分配时间</th>"+
		"<th>固定电话</th>"+
		"<th>邮箱</th>"+
		"<th>单位</th>"+      
		"<th>单位地址</th>"+
...
function fillTable(list,currentPage){ 
	$.each(list, function(index, array) {
	    ...
	    tableItem ="<tr data-id="+studentId+">"+
	        ...
	        "<td class='phone' style='width: 120px;position: fixed;background: #fff;left: 237px;'>"+phone+"</td>"+
	        "<td style='width: 150px;position: fixed;background: #fff;left: 356px;'>"+idCard+"</td>"+
	        "<td style='width: 580px;padding-left: 510px;'>"+studentstate+"</td>"+
	        "<td>"+belongName+"</td>"+
	        "<td>"+arrive_money+"</td>"+
	        "<td>"+subjectname+"</td>"+
	        "<td>"+school+"</td>"+
