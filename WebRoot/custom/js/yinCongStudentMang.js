...
var tableHeader = "<tr class='henglan'>"+
		...
		"<th class='flfg'>法律法规与综合能力</th>"+
		"<th class='flfgScore'>考试成绩</th>"+
		"<th class='grlc'>个人理财</th>"+
		"<th class='grlcScore'>考试成绩</th>"+
		"<th class='fxgl'>风险管理</th>"+
		"<th class='fxglScore'>考试成绩</th>"+
		"<th class='gsxd'>公司信贷</th>"+
		"<th class='gsxdScore'>考试成绩</th>"+
		"<th class='grdk'>个人贷款</th>"+
		"<th class='grdkScore'>考试成绩</th>"+		
...
function fillTable(list,currentPage){ 
	$.each(list, function(index, array) {
	    ...
	    var gsxd = array.gsxd|| "";
	    var grdk = array.grdk|| "";
	    var flfgScore = array.flfgScore|| "";
	    var grlcScore = array.grlcScore|| "";
	    var fxglScore = array.fxglScore|| "";
	    var gsxdScore = array.gsxdScore|| "";
	    var grdkScore = array.grdkScore|| "";
	    var courseversion = array.courseversion|| "";
	    var customerName = array.customerName || "";
	    ...
	    tableItem ="<tr data-id="+studentId+" style='background-color:"+studentColor+"'>"+
	        ...
	        "<td class='flfg'>"+flfg+"</td>"+
            "<td class='flfgScore'>"+flfgScore+"</td>"+
            "<td class='grlc'>"+grlc+"</td>"+
            "<td class='grlcScore'>"+grlcScore+"</td>"+
            "<td class='fxgl'>"+fxgl+"</td>"+
            "<td class='fxglScore'>"+fxglScore+"</td>"+
            "<td class='gsxd'>"+gsxd+"</td>"+
            "<td class='gsxdScore'>"+gsxdScore+"</td>"+
            "<td class='grdk'>"+grdk+"</td>"+
            "<td class='grdkScore'>"+grdkScore+"</td>"+
