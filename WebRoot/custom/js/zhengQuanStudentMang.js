...
var tableHeader = "<tr class='henglan'>"+
		...
		"<th class='zqsc'>证券市场基本法律法规</th>"+
		"<th class='zqscScore'>考试成绩</th>"+
		"<th class='jrsc'>金融市场基础知识</th>"+
		"<th class='jrscScore'>考试成绩</th>"+
...
function fillTable(list,currentPage){ 
	$.each(list, function(index, array) {
	    ...
	    var zqsc = array.zqsc|| "";
	    var jrsc = array.jrsc|| "";	    
	    var zqscScore = array.zqscScore|| "";
	    var jrscScore = array.jrscScore|| "";	    
	    ...
	    tableItem ="<tr data-id="+studentId+" style='background-color:"+studentColor+"'>"+
	        ...
	        "<td class='zqsc'>"+zqsc+"</td>"+
	        "<td class='zqscScore'>"+zqscScore+"</td>"+
	        "<td class='jrsc'>"+jrsc+"</td>"+
	        "<td class='jrscScore'>"+jrscScore+"</td>"+
