...
<body>
	...
	<div class="table-responsive" data-example-id="simple-table">		
        <table class="table table-bordered table-hover table-striped able-condensed" id="resourceTable" style="width: 2600px;border:none;">              	                   
            <tr class="henglan">
			...
			<form class="form-horizontal add_form">
				...
				<div class="form-group">
					<div class="col-md-offset-4 col-md-6">
						<a href="javascript:;" class="btn addsave" onclick="addnewStudent(this)">保 存</a>						
	...
	<script type="text/javascript" src="../sales/js/studentMang.js"></script>
