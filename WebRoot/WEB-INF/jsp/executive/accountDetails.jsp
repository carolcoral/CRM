		...
		<div class="detailseWrap">
			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">分配客服时间：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="customer_time" disabled="disabled" id="customer_time" value="${liststudent.customer_time}"></input>
						</div>
					</div>	
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">学员状态：</label>
						<div class="col-md-8">
							<input  class="form-control" type="text" name="studentstate" id="studentstate"  value="<c:if test="${liststudent.studentstate ==0}">新增</c:if><c:if test="${liststudent.studentstate ==1}">已成交</c:if><c:if test="${liststudent.studentstate ==2}">已提交</c:if><c:if test="${liststudent.studentstate ==3}">已到账</c:if><c:if test="${liststudent.studentstate ==5}">已转入</c:if><c:if test="${liststudent.studentstate ==7}">已关课</c:if><c:if test="${liststudent.studentstate ==8}">已退回</c:if>" disabled="disabled"/>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">渠道：</label>
						<div class="col-md-8">							
							<input  class="form-control" type="text" name="source" disabled="disabled" value="<c:if test="${liststudent.source ==1}">课程注册</c:if><c:if test="${liststudent.source ==2}">在线注册</c:if><c:if test="${liststudent.source ==3}">app下载注册</c:if><c:if test="${liststudent.source ==4}">电话咨询</c:if><c:if test="${liststudent.source ==5}">金考网注册用户</c:if><c:if test="${liststudent.source ==6}">线上渠道</c:if><c:if test="${liststudent.source ==7}">在线注册</c:if><c:if test="${liststudent.source ==8}">大库资源</c:if>"/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<select class="form-control" name="resourceLevel" id="resourceLevel">
								<option value="A" <c:if test="${liststudent.resourceLevel == 'A'}">selected="selected"</c:if>>A</option>
								<option value="B" <c:if test="${liststudent.resourceLevel == 'B'}">selected="selected"</c:if>>B</option>
								<option value="C" <c:if test="${liststudent.resourceLevel == 'C'}">selected="selected"</c:if>>C</option>
								<option value="D" <c:if test="${liststudent.resourceLevel == 'D'}">selected="selected"</c:if>>D</option>
							</select>
						</div>
					</div>					
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<select class="form-control" name="sex" id="sex">
								<option value="1" <c:if test="${liststudent.resourceLevel == '1'}">selected="selected"</c:if>>女</option>
								<option value="0" <c:if test="${liststudent.resourceLevel == '0'}">selected="selected"</c:if>>男</option>
							</select>
						</div>
					</div>					
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="phone" id="phone" value="${liststudent.phone}"></input>
						</div>
					</div>			
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">班主任：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="headmaster" id="headmaster" value="${liststudent.headmaster}"></input>
						</div>
					</div>	
					<div class="form-group">
					...
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">民族：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="nation" id="nation" value="${liststudent.nation}"></input>							
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">到账金额：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="arrive_money" disabled="disabled"  id="arrive_money" value="${liststudent.arrive_money}"></input>					
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">到账日期：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="arrive_time" disabled="disabled"  id="arrive_time" value="${liststudent.arrive_time}"></input>					
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">到账方式：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="remitWay" disabled="disabled"  id="remitWay" value="${liststudent.remitWay}"></input>					
						</div>
					</div>	
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">理财网用户名：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="LCWname" id="LCWname" value="${liststudent.LCWname}"></input>					
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">理财网密码：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="LCWpassword" id="LCWpassword" value="${liststudent.LCWpassword}"></input>					
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">理财网过期时间：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="LCWoutTime" id="LCWoutTime" value="${liststudent.LCWoutTime}"></input>					
						</div>
					</div>
					<div class="form-group">
			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">是否协助结业：</label>
						<div class="col-md-8">
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">上课班号：</label>
						<div class="col-md-8">
							<input  class="form-control" type="text" name="classNum" id="classNum" value="${liststudent.classNum}"/>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">课件版本：</label>
						<div class="col-md-8">
							<input  class="form-control" type="text" name="courseversion" id="courseversion" value="${liststudent.courseversion}"/>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">邮寄时间：</label>
						<div class="col-md-8">
							<input  class="form-control" type="text" name="mailTime" id="mailTime"  value="${liststudent.mailTime}"/>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">是否上过课：</label>
						<div class="col-md-8">
							<select class="form-control" name="isHaveCourse" id="isHaveCourse">
								<option value="0" <c:if test="${liststudent.isHaveCourse == '0'}">selected="selected"</c:if>>未上过课</option>
								<option value="1" <c:if test="${liststudent.isHaveCourse == '1'}">selected="selected"</c:if>>已上过课</option>
								
							</select>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">是否签订协议：</label>
						<div class="col-md-8">
					...
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">报考密码：</label>
						<div class="col-md-8">
							<input  class="form-control" type="text" name="baokaopassword" id=baokaopassword value="${liststudent.baokaopassword}"/>
						</div>
					</div>
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">提交行政日期：</label>
						<div class="col-md-8">
							<input  class="form-control" type="text" disabled="disabled" name="commit_time" id="commit_time" value="${liststudent.commit_time}"/>
						</div>
					</div>			
					<div class="form-group">
						<label for="inputEmail3" class="col-md-3 control-label">发票情况：</label>
						<div class="col-md-8">
							<input  class="form-control" type="text"  name="invoiceinfo" id="invoiceinfo" value="${liststudent.invoiceinfo}"/>
						</div>
					</div>					
					<div class="form-group">
					    <div class="col-md-offset-9 col-md-3">
					      <button type="button" class="btn btn-danger" onclick="savedetail()">保存</button>
					    </div>
					</div>	
				</form>
			</div>
...
<script type="text/javascript">
	...
	$('textarea,input,select').attr('disabled',true);
	$('#studentName').attr('disabled',false);
	$('#phone').attr('disabled',false);
	$('#idCard').attr('disabled',false);
	$('#banci').attr('disabled',false);
