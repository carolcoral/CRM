...
<c:forEach items="${liststudent}" var="liststudent">
			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">					
						...
						<div class="col-md-8">
							<input  class="form-control" type="text" id="banci" value="${liststudent.banci}"/>
							<%-- <select class="form-control" name="banci" id="banci">
								...
								<option value="其他" <c:if test="${liststudent.banci == '其他'}">selected="selected"</c:if>>其他</option>
							</select> --%>
						</div>	
					</div>
					<div class="form-group">
	...
	<div id="changedeal"  class="ui-wrap">
		<div class="addnew-wrap"style="top: 50%;">
...
<script type="text/javascript" src="../executive/js/studentDetails.js"></script>
</body>
</html>
