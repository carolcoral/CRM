			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="baokaopassword" id="baokaopassword" disabled="disabled" value="${liststudent.baokaopassword}"></input>					
						</div>
					</div>
					<div class="form-group">
...
<script type="text/javascript">
	...
	if($.trim(specialinfo) != "" && $.trim(specialinfo) != null){
		...
		$('#tipinfo').html("此学员情况特殊，请在【特殊学员】中查看");
