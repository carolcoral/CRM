			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="headmaster" id="headmaster"  disabled="disabled" value="${liststudent.headmaster}"></input>
						</div>
					</div>	
					<div class="form-group">
			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="remitWay" id="remitWay" value="${liststudent.remitWay}"></input>					
						</div>
					</div>
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">课件版本：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="courseversion" id="courseversion" disabled="disabled" value="${liststudent.courseversion}"></input>					
						</div>
					</div>					
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">邮寄时间：</label>
						<div class="col-md-8">
							<input class="form-control" rows="3" name="mailTime" id="mailTime" disabled="disabled" value="${liststudent.mailTime}"></input>					
						</div>
					</div>		
					<div class="form-group">
					...
					<div class="form-group">					
						...
						<div class="col-md-8">
							<select class="form-control" name="banci" id="banci" disabled="disabled">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="scoretime" id="scoretime" disabled="disabled" value="${liststudent.scoretime}"></input>					
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="kefuNote1" id="kefuNote1" disabled="disabled" value="${liststudent.kefuNote1}"></input>					
						</div>
					</div>	
					<div class="form-group">
						<label for="inputPassword3" class="col-md-3 control-label">学员评价：</label>
						<div class="col-md-8">
							<select class="form-control" name="pingjia" id="pingjia" disabled="disabled">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<select class="form-control" name="specialinfo" id="specialinfo">
							    ...
							    <option value="后付费" <c:if test="${liststudent.specialinfo == '后付费'}">selected="selected"</c:if>>后付费</option>
...
<div class="themisWrap" style="display:none;" >
  <div class="themisGray"></div>
    <div class="themis" style="top:30%;">
       ...
       <div class="themispay">
            <div class="themistip" style="margin-bottom: 20px; color:red; font-size:14px;"><span id="tipinfo"></span>手机：<span id="showphone"></span></div>                             
            <button class="btn navbar-right" id="patterTypeDel" style="background: #4c7cba;" onclick="parent.showdeiatil()">确定</button>                    
       </div>
    </div>
</div> 	
...
<script type="text/javascript">
	...
	if($.trim(specialinfo) == "" && $.trim(specialinfo) == null && $.trim(ispass) == "通过"){
		$('.themisWrap').css('display','block');
		$('#tipinfo').html("非情况特殊学员，请在【通过学员】中查看");
		$('#showphone').html(phone);
	}else if($.trim(specialinfo) == "" && $.trim(specialinfo) == null && $.trim(ispass) != "通过"){
		$('.themisWrap').css('display','block');
		$('#tipinfo').html("此学员有科目未通过或缺考，请在【回访学员】中查看");
		$('#showphone').html(phone);
	}
</script>
</body>
