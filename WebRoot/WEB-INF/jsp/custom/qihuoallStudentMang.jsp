...
<body>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<form class="navbar-form navbar-left ng-pristine ng-valid" role="search">
						...
						<a href="javascript:;" class="btn" style="background: #4c7cba;" onclick="qhquery()">查询</a>
					</form>
				</ul>
	...
	<div class="table-responsive" data-example-id="simple-table">		
        <table class="table table-bordered table-hover table-striped able-condensed" id="AFPallTable" style="width: 2400px;border:none;">              	                   
           <!--  <tr class="henglan">
   ...
   <!-- 筛选 -->
	...
	<script type="text/javascript" src="../custom/js/qihuoallStudentMang.js"></script>
