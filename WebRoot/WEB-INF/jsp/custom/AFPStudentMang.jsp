...
<body>
	...
	<div class="table-responsive" data-example-id="simple-table">		
        <table class="table table-bordered table-hover table-striped able-condensed" id="resourceTable" style="width: 3000px;border:none;">              	                   
            <!-- <tr class="henglan">
                ...
                <th class="matchinfo_time" style="width:180px;">成交时间</th>   
                ...
                <th class="isSignAgreement">协议</th>
                <th class="weixin">微信</th>
                <th class="classNum">上课班号</th>
                <th class="courseversion">课件情况</th>
            </tr> -->
           <!--  <tr class="henglan">
	...
	<script type="text/javascript" src="../custom/js/AFPStudentMang.js"></script>
