			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="scoretime" id="scoretime" value="${liststudent.scoretime}"></input>					
						</div>
					</div>
				...
				<form class="form-horizontal" role="form">								
					...
					<table class="table table-bordered  table-hover" id="dealtable">								
						...
						<tr data-id="${dealrecord.dealrecordId}">
							...
							<td id="showsubject" data-id="${dealrecord.subjectid}">${dealrecord.subjectname}</td>
