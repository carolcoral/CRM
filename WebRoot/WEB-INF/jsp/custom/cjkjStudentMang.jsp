...
<body>
	...
	<div class="table-responsive" data-example-id="simple-table">		
        <table class="table table-bordered table-hover table-striped able-condensed" id="resourceTable" style="width: 1800px;border:none;">              	                   
            <tr class="henglan">
	...
	<script type="text/javascript" src="../custom/js/cjkjStudentMang.js"></script>
