...
<body>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<form class="navbar-form navbar-left ng-pristine ng-valid" role="search">
						...
						<a href="javascript:;" onclick="cfpfastquery()" class="btn" style="background: #4c7cba;">查询</a>
					</form>
				</ul>
	...
	<div class="table-responsive" data-example-id="simple-table">		
        <table class="table table-bordered table-hover table-striped able-condensed" id="AFPallTable" style="width: 4500px;border:none;">              	                   
           <!--  <tr class="henglan">
   ...
   <!-- 筛选 -->
	...
	<script type="text/javascript" src="../custom/js/CFPallStudentMang.js"></script>
