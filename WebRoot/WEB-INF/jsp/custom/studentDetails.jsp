...
<c:forEach items="${liststudent}" var="liststudent">
	<div class="detailscom">		
		<h2 class="detailTti">基本信息<a class="btn navbar-left" href="javascript:;" onclick="self.location=document.referrer;">
			...
			<div class="detailsedit">
				<form class="form-horizontal" role="form">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input  class="form-control" type="text" id="studentstate"  value="<c:if test="${liststudent.studentstate ==0}">新增</c:if><c:if test="${liststudent.studentstate ==1}">已成交</c:if><c:if test="${liststudent.studentstate ==2}">已提交</c:if><c:if test="${liststudent.studentstate ==3}">已到账</c:if><c:if test="${liststudent.studentstate ==5}">已转入</c:if><c:if test="${liststudent.studentstate ==7}">已关课</c:if><c:if test="${liststudent.studentstate ==8}">已退回</c:if>" disabled="disabled"/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							...
							<span class="error" id="headmasterError"></span>
						</div>
					</div>	
					<div class="form-group">
			...
			<form class="form-horizontal" role="form">
				<div id="saveinfor" style="display:none">	
					<div class="form-group">
						...
						<div class="col-md-8">
							<input class="form-control" rows="3" name="dealtime" id="dealtime"></input>
				...
				<label for="inputPassword3" class="col-md-3 control-label">成交记录:</label>
				<table class="table table-bordered  table-hover" id="dealtable">								
					...
					<tr data-id="${liststudent.studentId}">
						...
						<td class="text-primary">${dealrecord.subjectname}</td>
		...
		<div class="addnew-wrap">
			...
			<div class="form-horizontal add_form">
				<div class="form-group">
					<label for="inputPassword3" class="col-md-3 control-label">成交时间:</label>
					<div class="col-md-8">
						<input class="form-control" rows="3" name="dealtime" id="ch-dealtime"></input>
					</div>
				</div>
				<div class="form-group">					
					<label for="inputPassword3" class="col-md-3 control-label">成交课程:</label>
