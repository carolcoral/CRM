...
<body>
	...
	<div id="filter"  class="ui-wrap">
		<div class="addnew-wrap">
			...
			<form class="form-horizontal add_form" id="excel">				
				...
				<div class="form-group">
					<label for="inputPassword3" class="col-md-3 control-label">是否全科通过</label>
					<div class="col-md-9">
				...
				<div class="form-group">
					<label for="inputPassword3" class="col-md-3 control-label">科一是否通过</label>
					<div class="col-md-9">
						<select class="form-control" name="ispass" id="ispass1">
							<option value="">请选择是否通过</option>
							<option value="0">未通过</option>
							<option value="1">通过</option>
							<option value="2">缺考</option>
				...
				<div class="form-group">
					<label for="inputPassword3" class="col-md-3 control-label">科二是否通过</label>
					<div class="col-md-9">
						<select class="form-control" name="ispass" id="ispass2">
							<option value="">请选择是否通过</option>
							<option value="0">未通过</option>
							<option value="1">通过</option>
							<option value="2">缺考</option>
	...
	<script type="text/javascript" src="../custom/js/jiJinStudentMang.js"></script>
